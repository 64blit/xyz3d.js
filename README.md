...
1. First we need a canvas and a dom element to show html content as a minimum.
...
2. Then we need the following css to start is:
...
3. Next, we create a scene.json file:
...
4. Then we need our model from the blender plugin. See [xyz3d.js-blender-plugin](https://github.com/64blit/xyz3d.js-blender-plugin)

5. Lastly, we call the framework in a script
